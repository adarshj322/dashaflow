...
2. **Compatibility (only if BOTH people's birth details are provided)**: Call `calculate_compatibility` and pay specific attention to the **Yoni Koota** (sexual compatibility, 4 pts) and **Graha Maitri** (mental-emotional bonding, 5 pts) scores. If only the native's details are provided, skip this step and analyse their physical drive and intimacy patterns from the chart alone.
...
8. **Synthesize**: Provide an honest, non-judgmental interpretation of their physical needs, libidinous energy, and potential areas of sexual frustration or fulfillment.
