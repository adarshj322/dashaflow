"""
Comprehensive Test Suite for DashaFlow Vedic Astrology Library
================================================================
...
from dashaflow.vedic_calculator import (
...
from dashaflow.dignity import get_dignity, check_combustion, get_digbala
...
from dashaflow.yoga import detect_yogas, detect_kaal_sarpa, detect_graha_yuddha, detect_gandanta
...
# ===================================================================
# 35. PUBLIC API -- test dashaflow top-level functions
# ===================================================================
class TestPublicAPI(unittest.TestCase):

    def test_cast_chart_returns_dict(self):
        import dashaflow
    ...
    def test_cast_chart_invalid_date_raises(self):
        import dashaflow
        with self.assertRaises(ValueError):
            dashaflow.cast_chart("bad-date", "14:30", 28.6139, 77.2090, "Asia/Kolkata")

    def test_cast_chart_invalid_timezone_raises(self):
        import dashaflow
        with self.assertRaises(ValueError):
    ...
    def test_version_exists(self):
        ...
        self.assertRegex(dashaflow.__version__, r"^\d+\.\d+\.\d+")
